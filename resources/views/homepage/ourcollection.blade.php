<section class="section bg__section">
	<div class="container">
		<h2 id="collection" class="section__title bump">Our Collection</h2>

		<div class="columns">

		  <div class="column">
		    <h4 class="section__header">Home Furniture</h4>
		    <a href="/collection/home"><img src="/img/collection_ditre.jpg"></a>
		    <p class="block">Modern, Stylish and exclusive. Blue Gallery only stocks the highest standards of sofas, armchairs, coffee tables, Beds and mattresses for the contemporary living room.</p>
		    <a href="/collection/home"><button class="button is-medium">Show me More</button></a>
		  </div>
